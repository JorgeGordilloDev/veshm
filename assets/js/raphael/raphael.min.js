    ...
    function (t, e, r) {
      ...
      (i = [r(2)]),
        (n = function (t) {
          ...
          function x() {
            return this.x + j + this.y + j + this.width + " Ã— " + this.height;
          }
          ...
          var Pt = function (t) {
              if (e.vml) {
                ...
                (l.title = "RaphaÃ«l Colour Picker"),
            ...
            (e._removedFactory = function (e) {
              return function () {
                t(
                  "raphael.log",
                  null,
                  "RaphaÃ«l: you are calling to method â€œ" +
                    e +
                    "â€ of removed object",
                  e
                );
                ...
                (this.bottom = this.top = null),
                  (this.desc = v("desc")).appendChild(
                    t._g.doc.createTextNode(
                      "Created with RaphaÃ«l " + t.version
                    )
                  ),
      ...
      (i = [r(1)]),
        (n = function (t) {
          if (!t || t.vml) {
            ...
            t.toString = function () {
              return (
                "Your browser doesnâ€™t support SVG. Falling down to VML.\nYou are running RaphaÃ«l " +
                this.version
              );
            };
